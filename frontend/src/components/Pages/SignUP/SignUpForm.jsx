    ...
    <div className="w-full max-w-sm mx-auto mt-10">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="relative flex items-center">
          <User className="absolute left-3 w-5 h-5 text-gray-400 dark:text-gray-600" />
          <input
            type="text"
            name="name"
        ...
        <div className="relative flex items-center">
          <Phone className="absolute left-3 w-5 h-5 text-gray-400 dark:text-gray-600" />
          <input
            type="tel"
            name="number"
        ...
        <button type="submit" className="w-full bg-blue-600 dark:bg-blue-500 text-white py-3 px-4 rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors duration-200 font-medium focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:ring-offset-2">
          Create Account
        </button>
